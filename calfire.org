...
Each category has multiple potential fates which can greatly influence the net emissions impact attributed to the initial forest management activity. While wood products used in construction or finished products may sequester carbon in a stable environment for a long period, residues sent to landfills or left in the woods as slash emit climate forcing gasses. Some of these wood residues may be further directed towards alternative product streams (i.e., chip, power and heat generation) with controlled combustion, but ultimately the fate of each of these pools is determined by a highly dynamic political and economic system. To understand how policy decisions will impact the fate and subsequent climate impact of harvested wood products, a detailed process model tracking the source and volume of harvested wood utilization is necessary. Figure ref:wood_fates
