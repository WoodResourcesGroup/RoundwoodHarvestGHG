...
reasonable considering that there is not financial incentive to
under-report under the TPO data collection protocol.
...
#+RESULTS: tab:tpo_boe
| year | Mciver2012 MMBF                  | BOE MMBF | BOE/M&M |
|------+-----------------+----------+---------|
...
average on average over time has changed.  
...
from 2000 -- 2012. These results assume bioenergy application
