...
* Estimating emissions from harvested wood
Harvested wood from California's forests are used in a variety of construction,
landscaping, and consumer products. This wood is fractionated through a multi-stage process of harvesting, processing, use, and disposal into several categories for which the time horizon of carbon return to the atmosphere varies widely. Wood residues generated from each stage of this process may also be directed towards alternative product streams (i.e., power and heat generation)
to divert the volume of material sent to landfills or left in the
woods as slash.
